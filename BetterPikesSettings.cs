...
namespace BetterPikes
{
    public class BetterPikesSettings : AttributeGlobalSettings<BetterPikesSettings>
    {
        ...
        [SettingPropertyInteger("{=BetterPikes05}Pike Blow Magnitude", 1, 100, "0", Order = 0, RequireRestart = false, HintText = "{=BetterPikes06}Multiplier for blow magnitude of pikes. Default is 4.")]
        [SettingPropertyGroup("{=BetterPikes01}Multipliers", GroupOrder = 0)]
        public int PikeBlowMagnitudeMultiplier { get; set; } = 4;
